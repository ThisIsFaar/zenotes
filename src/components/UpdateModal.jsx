...
const UpdateModal = ({ updateModalToggler, note, getNotes }) => {
  ...
  const { title, tagline, description, id } = values;

  const deleteNote = async (e) => {
    e.preventDefault();
    await NoteDataServices.deleteNote(id);
    updateModalToggler();
  ...
  const updateNote = async (e) => {
    ...
    try {
      await NoteDataServices.updateNote(values.id, values);
